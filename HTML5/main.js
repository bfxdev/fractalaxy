var Godot = (function () {
  ...
  return function (Godot) {
    ...
    function _godot_js_input_touch_cb (callback, ids, coords) {
      ...
      function touch_cb (type, evt) {
        ...
        for (let i = 0; i < touches.length; i++) {
          ...
          GodotRuntime.setHeapValue(coords + (i * 2 + 1), pos[1], 'double')
    ...
    var asmLibraryArg = {
      ...
      Kb: _dlopen,
      yj: _dlsym,
      xj: _emscripten_asm_const_int,
      Jb: _emscripten_cancel_main_loop,
      wj: _emscripten_force_exit,
      vj: _emscripten_glActiveTexture,
      uj: _emscripten_glAttachShader,
      tj: _emscripten_glBeginQuery,
      sj: _emscripten_glBeginQueryEXT,
      rj: _emscripten_glBeginTransformFeedback,
      qj: _emscripten_glBindAttribLocation,
      pj: _emscripten_glBindBuffer,
      oj: _emscripten_glBindBufferBase,
      nj: _emscripten_glBindBufferRange,
      mj: _emscripten_glBindFramebuffer,
      lj: _emscripten_glBindRenderbuffer,
      kj: _emscripten_glBindSampler,
      jj: _emscripten_glBindTexture,
      ij: _emscripten_glBindTransformFeedback,
      hj: _emscripten_glBindVertexArray,
      gj: _emscripten_glBindVertexArrayOES,
      ...
      aj: _emscripten_glBlitFramebuffer,
      $i: _emscripten_glBufferData,
      _i: _emscripten_glBufferSubData,
      Zi: _emscripten_glCheckFramebufferStatus,
      Yi: _emscripten_glClear,
      Xi: _emscripten_glClearBufferfi,
      Wi: _emscripten_glClearBufferfv,
      Vi: _emscripten_glClearBufferiv,
      Ui: _emscripten_glClearBufferuiv,
      Ti: _emscripten_glClearColor,
      Si: _emscripten_glClearDepthf,
      Ri: _emscripten_glClearStencil,
      Qi: _emscripten_glClientWaitSync,
      Pi: _emscripten_glColorMask,
      Oi: _emscripten_glCompileShader,
      Ni: _emscripten_glCompressedTexImage2D,
      Mi: _emscripten_glCompressedTexImage3D,
      Li: _emscripten_glCompressedTexSubImage2D,
      Ki: _emscripten_glCompressedTexSubImage3D,
      Ji: _emscripten_glCopyBufferSubData,
      Ii: _emscripten_glCopyTexImage2D,
      Hi: _emscripten_glCopyTexSubImage2D,
      Gi: _emscripten_glCopyTexSubImage3D,
      Fi: _emscripten_glCreateProgram,
      Ei: _emscripten_glCreateShader,
      Di: _emscripten_glCullFace,
      Ci: _emscripten_glDeleteBuffers,
      Bi: _emscripten_glDeleteFramebuffers,
      Ai: _emscripten_glDeleteProgram,
      zi: _emscripten_glDeleteQueries,
      yi: _emscripten_glDeleteQueriesEXT,
      xi: _emscripten_glDeleteRenderbuffers,
      wi: _emscripten_glDeleteSamplers,
      vi: _emscripten_glDeleteShader,
      ui: _emscripten_glDeleteSync,
      ti: _emscripten_glDeleteTextures,
      si: _emscripten_glDeleteTransformFeedbacks,
      ri: _emscripten_glDeleteVertexArrays,
      qi: _emscripten_glDeleteVertexArraysOES,
      pi: _emscripten_glDepthFunc,
      oi: _emscripten_glDepthMask,
      ni: _emscripten_glDepthRangef,
      mi: _emscripten_glDetachShader,
      li: _emscripten_glDisable,
      ki: _emscripten_glDisableVertexAttribArray,
      ji: _emscripten_glDrawArrays,
      ii: _emscripten_glDrawArraysInstanced,
      hi: _emscripten_glDrawArraysInstancedANGLE,
      gi: _emscripten_glDrawArraysInstancedARB,
      fi: _emscripten_glDrawArraysInstancedEXT,
      ei: _emscripten_glDrawArraysInstancedNV,
      di: _emscripten_glDrawBuffers,
      ci: _emscripten_glDrawBuffersEXT,
      bi: _emscripten_glDrawBuffersWEBGL,
      ai: _emscripten_glDrawElements,
      $h: _emscripten_glDrawElementsInstanced,
      _h: _emscripten_glDrawElementsInstancedANGLE,
      Zh: _emscripten_glDrawElementsInstancedARB,
      Yh: _emscripten_glDrawElementsInstancedEXT,
      Xh: _emscripten_glDrawElementsInstancedNV,
      Wh: _emscripten_glDrawRangeElements,
      Vh: _emscripten_glEnable,
      Uh: _emscripten_glEnableVertexAttribArray,
      Th: _emscripten_glEndQuery,
      Sh: _emscripten_glEndQueryEXT,
      Rh: _emscripten_glEndTransformFeedback,
      Qh: _emscripten_glFenceSync,
      ...
      Lh: _emscripten_glFramebufferTextureLayer,
      Kh: _emscripten_glFrontFace,
      Jh: _emscripten_glGenBuffers,
      Ih: _emscripten_glGenFramebuffers,
      Hh: _emscripten_glGenQueries,
      Gh: _emscripten_glGenQueriesEXT,
      Fh: _emscripten_glGenRenderbuffers,
      Eh: _emscripten_glGenSamplers,
      Dh: _emscripten_glGenTextures,
      Ch: _emscripten_glGenTransformFeedbacks,
      Bh: _emscripten_glGenVertexArrays,
      Ah: _emscripten_glGenVertexArraysOES,
      zh: _emscripten_glGenerateMipmap,
      yh: _emscripten_glGetActiveAttrib,
      xh: _emscripten_glGetActiveUniform,
      wh: _emscripten_glGetActiveUniformBlockName,
      vh: _emscripten_glGetActiveUniformBlockiv,
      uh: _emscripten_glGetActiveUniformsiv,
      th: _emscripten_glGetAttachedShaders,
      sh: _emscripten_glGetAttribLocation,
      rh: _emscripten_glGetBooleanv,
      qh: _emscripten_glGetBufferParameteri64v,
      ph: _emscripten_glGetBufferParameteriv,
      oh: _emscripten_glGetError,
      nh: _emscripten_glGetFloatv,
      mh: _emscripten_glGetFragDataLocation,
      lh: _emscripten_glGetFramebufferAttachmentParameteriv,
      kh: _emscripten_glGetInteger64i_v,
      jh: _emscripten_glGetInteger64v,
      ih: _emscripten_glGetIntegeri_v,
      hh: _emscripten_glGetIntegerv,
      gh: _emscripten_glGetInternalformativ,
      fh: _emscripten_glGetProgramBinary,
      eh: _emscripten_glGetProgramInfoLog,
      dh: _emscripten_glGetProgramiv,
      ch: _emscripten_glGetQueryObjecti64vEXT,
      bh: _emscripten_glGetQueryObjectivEXT,
      ah: _emscripten_glGetQueryObjectui64vEXT,
      $g: _emscripten_glGetQueryObjectuiv,
      _g: _emscripten_glGetQueryObjectuivEXT,
      Zg: _emscripten_glGetQueryiv,
      Yg: _emscripten_glGetQueryivEXT,
      Xg: _emscripten_glGetRenderbufferParameteriv,
      Wg: _emscripten_glGetSamplerParameterfv,
      Vg: _emscripten_glGetSamplerParameteriv,
      Ug: _emscripten_glGetShaderInfoLog,
      Tg: _emscripten_glGetShaderPrecisionFormat,
      Sg: _emscripten_glGetShaderSource,
      Rg: _emscripten_glGetShaderiv,
      Qg: _emscripten_glGetString,
      Pg: _emscripten_glGetStringi,
      Og: _emscripten_glGetSynciv,
      Ng: _emscripten_glGetTexParameterfv,
      Mg: _emscripten_glGetTexParameteriv,
      Lg: _emscripten_glGetTransformFeedbackVarying,
      Kg: _emscripten_glGetUniformBlockIndex,
      Jg: _emscripten_glGetUniformIndices,
      Ig: _emscripten_glGetUniformLocation,
      Hg: _emscripten_glGetUniformfv,
      Gg: _emscripten_glGetUniformiv,
      Fg: _emscripten_glGetUniformuiv,
      Eg: _emscripten_glGetVertexAttribIiv,
      Dg: _emscripten_glGetVertexAttribIuiv,
      Cg: _emscripten_glGetVertexAttribPointerv,
      Bg: _emscripten_glGetVertexAttribfv,
      Ag: _emscripten_glGetVertexAttribiv,
      zg: _emscripten_glHint,
      yg: _emscripten_glInvalidateFramebuffer,
      xg: _emscripten_glInvalidateSubFramebuffer,
      wg: _emscripten_glIsBuffer,
      vg: _emscripten_glIsEnabled,
      ug: _emscripten_glIsFramebuffer,
      tg: _emscripten_glIsProgram,
      sg: _emscripten_glIsQuery,
      rg: _emscripten_glIsQueryEXT,
      qg: _emscripten_glIsRenderbuffer,
      pg: _emscripten_glIsSampler,
      og: _emscripten_glIsShader,
      ng: _emscripten_glIsSync,
      mg: _emscripten_glIsTexture,
      lg: _emscripten_glIsTransformFeedback,
      kg: _emscripten_glIsVertexArray,
      jg: _emscripten_glIsVertexArrayOES,
      ig: _emscripten_glLineWidth,
      hg: _emscripten_glLinkProgram,
      gg: _emscripten_glPauseTransformFeedback,
      fg: _emscripten_glPixelStorei,
      eg: _emscripten_glPolygonOffset,
      dg: _emscripten_glProgramBinary,
      cg: _emscripten_glProgramParameteri,
      bg: _emscripten_glQueryCounterEXT,
      ag: _emscripten_glReadBuffer,
      $f: _emscripten_glReadPixels,
      _f: _emscripten_glReleaseShaderCompiler,
      Zf: _emscripten_glRenderbufferStorage,
      Yf: _emscripten_glRenderbufferStorageMultisample,
      Xf: _emscripten_glResumeTransformFeedback,
      Wf: _emscripten_glSampleCoverage,
      Vf: _emscripten_glSamplerParameterf,
      Uf: _emscripten_glSamplerParameterfv,
      Tf: _emscripten_glSamplerParameteri,
      Sf: _emscripten_glSamplerParameteriv,
      Rf: _emscripten_glScissor,
      Qf: _emscripten_glShaderBinary,
      Pf: _emscripten_glShaderSource,
      Of: _emscripten_glStencilFunc,
      Nf: _emscripten_glStencilFuncSeparate,
      Mf: _emscripten_glStencilMask,
      Lf: _emscripten_glStencilMaskSeparate,
      Kf: _emscripten_glStencilOp,
      Jf: _emscripten_glStencilOpSeparate,
      If: _emscripten_glTexImage2D,
      Hf: _emscripten_glTexImage3D,
      Gf: _emscripten_glTexParameterf,
      Ff: _emscripten_glTexParameterfv,
      Ef: _emscripten_glTexParameteri,
      Df: _emscripten_glTexParameteriv,
      Cf: _emscripten_glTexStorage2D,
      Bf: _emscripten_glTexStorage3D,
      Af: _emscripten_glTexSubImage2D,
      zf: _emscripten_glTexSubImage3D,
      yf: _emscripten_glTransformFeedbackVaryings,
      xf: _emscripten_glUniform1f,
      wf: _emscripten_glUniform1fv,
      vf: _emscripten_glUniform1i,
      uf: _emscripten_glUniform1iv,
      tf: _emscripten_glUniform1ui,
      sf: _emscripten_glUniform1uiv,
      rf: _emscripten_glUniform2f,
      qf: _emscripten_glUniform2fv,
      pf: _emscripten_glUniform2i,
      of: _emscripten_glUniform2iv,
      nf: _emscripten_glUniform2ui,
      mf: _emscripten_glUniform2uiv,
      lf: _emscripten_glUniform3f,
      kf: _emscripten_glUniform3fv,
      jf: _emscripten_glUniform3i,
      hf: _emscripten_glUniform3iv,
      gf: _emscripten_glUniform3ui,
      ff: _emscripten_glUniform3uiv,
      ef: _emscripten_glUniform4f,
      df: _emscripten_glUniform4fv,
      cf: _emscripten_glUniform4i,
      bf: _emscripten_glUniform4iv,
      af: _emscripten_glUniform4ui,
      $e: _emscripten_glUniform4uiv,
      _e: _emscripten_glUniformBlockBinding,
      Ze: _emscripten_glUniformMatrix2fv,
      Ye: _emscripten_glUniformMatrix2x3fv,
      Xe: _emscripten_glUniformMatrix2x4fv,
      We: _emscripten_glUniformMatrix3fv,
      Ve: _emscripten_glUniformMatrix3x2fv,
      Ue: _emscripten_glUniformMatrix3x4fv,
      Te: _emscripten_glUniformMatrix4fv,
      Se: _emscripten_glUniformMatrix4x2fv,
      Re: _emscripten_glUniformMatrix4x3fv,
      Qe: _emscripten_glUseProgram,
      Pe: _emscripten_glValidateProgram,
      Oe: _emscripten_glVertexAttrib1f,
      Ne: _emscripten_glVertexAttrib1fv,
      Me: _emscripten_glVertexAttrib2f,
      Le: _emscripten_glVertexAttrib2fv,
      Ke: _emscripten_glVertexAttrib3f,
      Je: _emscripten_glVertexAttrib3fv,
      Ie: _emscripten_glVertexAttrib4f,
      He: _emscripten_glVertexAttrib4fv,
      Ge: _emscripten_glVertexAttribDivisor,
      Fe: _emscripten_glVertexAttribDivisorANGLE,
      Ee: _emscripten_glVertexAttribDivisorARB,
      De: _emscripten_glVertexAttribDivisorEXT,
      Ce: _emscripten_glVertexAttribDivisorNV,
      Be: _emscripten_glVertexAttribI4i,
      Ae: _emscripten_glVertexAttribI4iv,
      ze: _emscripten_glVertexAttribI4ui,
      ye: _emscripten_glVertexAttribI4uiv,
      xe: _emscripten_glVertexAttribIPointer,
      we: _emscripten_glVertexAttribPointer,
      ve: _emscripten_glViewport,
      ue: _emscripten_glWaitSync,
      te: _emscripten_memcpy_big,
      hb: _emscripten_resize_heap,
      Ib: _emscripten_set_main_loop,
      se: _emscripten_thread_sleep,
      ...
      oe: _emscripten_webgl_make_context_current,
      Dj: _environ_get,
      ...
      Fa: _glTexSubImage2D,
      Na: _glTexSubImage3D,
      ee: _glTransformFeedbackVaryings,
      g: _glUniform1f,
      v: _glUniform1i,
      ab: _glUniform1iv,
      wb: _glUniform1ui,
      ...
      ce: _glVertexAttribI4ui,
      Ba: _glVertexAttribIPointer,
      i: _glVertexAttribPointer,
      t: _glViewport,
      tb: _gmtime_r,
      be: _godot_audio_capture_start,
      ae: _godot_audio_capture_stop,
      $d: _godot_audio_has_script_processor,
      _d: _godot_audio_has_worklet,
      Zd: _godot_audio_init,
      Yd: _godot_audio_is_available,
      Xd: _godot_audio_resume,
      Wd: _godot_audio_script_create,
      Vd: _godot_audio_script_start,
      Ud: _godot_audio_worklet_create,
      Td: _godot_audio_worklet_start_no_threads,
      Sd: _godot_js_config_canvas_id_get,
      Rd: _godot_js_config_locale_get,
      Qd: _godot_js_display_alert,
      Pd: _godot_js_display_canvas_focus,
      Od: _godot_js_display_canvas_is_focused,
      Nd: _godot_js_display_clipboard_get,
      Md: _godot_js_display_clipboard_set,
      Ld: _godot_js_display_cursor_is_hidden,
      Kd: _godot_js_display_cursor_is_locked,
      Za: _godot_js_display_cursor_lock_set,
      sb: _godot_js_display_cursor_set_custom_shape,
      Jd: _godot_js_display_cursor_set_shape,
      Ya: _godot_js_display_cursor_set_visible,
      Id: _godot_js_display_desired_size_set,
      Hd: _godot_js_display_fullscreen_cb,
      Gd: _godot_js_display_fullscreen_exit,
      Fd: _godot_js_display_fullscreen_request,
    ...
    var __Z13godot_js_mainiPPc = (Module[
      '__Z13godot_js_mainiPPc'
    ] = function () {
    ...
    var __emwebxr_on_input_event = (Module[
    ...
    var __emwebxr_on_simple_event = (Module[
